...
def main(input_folder, output_folder, num_workers):
    ...
    file_pattern = re.compile(r".*_000[01]\.nii\.gz$")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Copy NIfTI files ending in _000[01].nii.gz from an input folder to an output folder using multiple processes."
    )
